class Node < ActiveRecord::Base
  ...
  enum rank: [
    ...
    :nothovariety, :order_rank, :parvorder, :phylum, :prole, :pseudovariety,
    :race, :section, :series, :species, :species_group, :species_subgroup,
    :status, :stirps, :subclass, :subdivision, :subfamily, :subform, :subgenus,
