...
RSpec.describe AssociationsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all associations as @associations" do
      ...
      expect(assigns(:associations)).to eq([association])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested association as @association" do
      ...
      expect(assigns(:association)).to eq(association)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new association as @association" do
      ...
      expect(assigns(:association)).to be_a_new(Association)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created association as @association" do
        post :create, {:association => valid_attributes}, valid_session
        expect(assigns(:association)).to be_a(Association)
        expect(assigns(:association)).to be_persisted
      end

      it "redirects to the created association" do
        post :create, {:association => valid_attributes}, valid_session
        expect(response).to redirect_to(Association.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved association as @association" do
        post :create, {:association => invalid_attributes}, valid_session
        expect(assigns(:association)).to be_a_new(Association)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested association" do
        association = Association.create! valid_attributes
        put :update, {:id => association.to_param, :association => new_attributes}, valid_session
        association.reload
      ...
      it "redirects to the association" do
        association = Association.create! valid_attributes
        put :update, {:id => association.to_param, :association => valid_attributes}, valid_session
        expect(response).to redirect_to(association)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the association as @association" do
        association = Association.create! valid_attributes
        put :update, {:id => association.to_param, :association => invalid_attributes}, valid_session
        expect(assigns(:association)).to eq(association)
      end
