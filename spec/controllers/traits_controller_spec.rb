  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created trait" do
        post :create, {:trait => valid_attributes}, valid_session
        expect(response).to redirect_to(Trait.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved trait as @trait" do
        post :create, {:trait => invalid_attributes}, valid_session
        expect(assigns(:trait)).to be_a_new(Trait)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested trait" do
        trait = Trait.create! valid_attributes
        put :update, {:id => trait.to_param, :trait => new_attributes}, valid_session
        trait.reload
      ...
      it "redirects to the trait" do
        trait = Trait.create! valid_attributes
        put :update, {:id => trait.to_param, :trait => valid_attributes}, valid_session
        expect(response).to redirect_to(trait)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the trait as @trait" do
        trait = Trait.create! valid_attributes
        put :update, {:id => trait.to_param, :trait => invalid_attributes}, valid_session
        expect(assigns(:trait)).to eq(trait)
      end
